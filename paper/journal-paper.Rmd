...
Different models also often contain a range of parameters that must be fit to data. Previous comparison work was thus hindered, either because the parameters have been allowed to vary freely across multiple conditions, or because models' performance is compared on different datasets. 
...
Second, in the *group fit* regime we fit each model to all conditions and datasets  
<!--G: (thus optimizing each model's parameters on 100% of data) --> 
and evaluate across all data. Though slightly overfit, this evaluation allows us to make the best test of generalization to other experiments from the literature. \vspace{-4pt}
