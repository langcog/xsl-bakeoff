...
Following earlier work, we first evaluate on small collections of annotated transcripts from the Rollins corpus, annotated by Frank, Goodman, & Tenenbaum (2009), and on transcripts from 24 English-speaking infants from Fernald & Morikawa (1993), annotated by Frank, Tenenbaum, & Fernald (2013). 
...
mention ages of children in Rollins and FM, and number of utterances (and unique nouns, maybe?)
