...
For each utterance in these corpora (referred to as FGT and FM, respectively), researchers viewed the video recordings and annotated which referents were in view of the child at the time of the utterance.

define gold lexicons, specify how many words/referents in each
...
describe strategy for constructing referent 'scenes' from adjacent utterances
