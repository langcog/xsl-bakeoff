...
<!-- G: why "word/referent" and not "word-referent pair"? Isn't it the pair that is presented 3-10 times? -->
...
<!-- G: maybe also mention varying the nature of the data? (both lab, and real life) -->
...
<!-- G: maybe "Different models often contain a range of parameters that must be fit to data. Previous comparison work was thus hindered, either because the parameters have been allowed to vary freely across multiple conditions, or because models' performance was compared on different datasets.  -->
Thus, we focus on out-of-sample prediction of human data using cross-validated parameter fits.
<!-- G: maybe "In this study, we undertake these challenges by using cross-validated parameter fits and focusing on out-of-sample prediction of human data for a range of cross-situational models. -->
