...
Although the combined size of the FGT and FM corpora are larger than most corpora used to test cross-situational word learning models in the literature, their utility is limited by the fact that both corpora are of similar contexts (play sessions) and only contain English-speaking children. They are also limited in size when compared to the large body of child-directed corpora that is available in CHILDES \cite{CHILDES}. Through the use of generated corpora, we are able to perform further comparisons on both larger and more diverse datasets that are not possible with the FGT and FM corpora. 
