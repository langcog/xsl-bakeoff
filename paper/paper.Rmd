...
Table 2 shows the correlations between model predictions made using the group-optimized parameters, and these relations are discussed below. 
...
kable(tab3, "latex", booktabs = T, digits = 3, caption="Correlations of models' predictions.") %>%
...
#print(tab3, type="latex", comment = F, include.rownames = T, table.placement = "H")
kable(gen_tab, "latex", booktabs = T, digits=3, caption = "Generalization experiment results.") %>%
  kable_styling(latex_options = "scale_down")
