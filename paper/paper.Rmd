...
### Strength-, Uncertainty-, & Novelty-biased (S,U,N) Models
...
```{r 2-col-image, fig.env = "figure*", fig.pos = "h", fig.width=7, fig.height=5.2, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "Human vs. model item-level accuracy using best-fitting parameters per model for all conditions (colored by condition)."}
# ToDo: relabel models, reorder by fit, and possibly add r or MSE to each plot
