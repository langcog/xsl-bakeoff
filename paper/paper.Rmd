...
Our primary outcome measure is the correlation between model average performance on a specific experimental condition and human performance on that same experimental condition. 
...
Second, we fit each model to all conditions and datasets. 
