...
```{r models-diverge}
k <- subset(gfd, Model=="kachergis")
f <- subset(gfd, Model=="fazly")

```


For which condition do these models make maximally divergent predictions?
This might help us design an experiment to best distinguish the models.
