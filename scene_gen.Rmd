...
generator <- function(utterances, scene_size, include_POS = c("nouns")) { 
  ...
  if(is.element("verbs",include_POS)) {
    final_POS = c(final_POS, c("v","cop","aux", "v:aux", "mod","part")) 
  } else if(is.element("nouns",include_POS)) {
    final_POS = c(final_POS, c("n","n:adj", "n:gerund","n:let","n:prop","n:pt"))
  } else {
    final_POS = include_POS
  }
  refs_scene = c()
