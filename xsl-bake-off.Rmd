...
run_Koehne_exp <- function(par, ord) {
  mp = model(par, ord)$m
...
evalSSE_Koehne <- function(par, hum_perf, verbose=F) {
  mod_perf = c( mean(run_Koehne_exp(par, aaappp)),
                mean(run_Koehne_exp(par, apapap)),
                mean(run_Koehne_exp(par, papapa)),
                mean(run_Koehne_exp(par, pppaaa)) )
